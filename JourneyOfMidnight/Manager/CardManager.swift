    ...
    private init() {
        self.myHeroCards = [
            ...
            Hero(
                ...
                items: [Item(name: "wands", intro: "Nature source is needed",price: 20, size: .small, isChose: false), /*Item(name: "Handbook", intro: "Handwritten")*/],
                stats: Stats(health: 100, endurance: 500),
...
//            ),
        ...
        self.enemy = [
            ...
            // 2 - Hero !!
            Hero(heroClass: HeroClass(name: .templar, level: 11, life: 180), attributes: Attributes(Strength: 5, Intelligence: 10, Wisdom: 7, Agility: 7, Vitality: 7, Faith: 7, Charisma: 7), skills: [Skill(name: "Holy", power: 5, size: .large,isSelected: false), Skill(name: "lightling", power: 3, size: .small,isSelected: false)], items: [Item(name: "holybook", intro: "Spirit", price: 20, size: .small, isChose: false), Item(name: "cross", intro: "Belief", price: 20, size: .small, isChose: false)], stats: Stats(health: 100, endurance: 500),
                 bag: [Item(name: "apple", intro: "Food", price: 5, size: .small, isChose: false)],
                 heroLoad: 4,
            ...
            // 3 - Follower
            Hero(heroClass: HeroClass(name: .duelist, level: 12, life: 80), attributes: Attributes(Strength: 6, Intelligence: 1, Wisdom: 9, Agility: 1, Vitality: 5, Faith: 1, Charisma: 5), skills: [Skill(name: "gun", power: 7,size: .small,isSelected: false)/*,Skill(name: "fist", power: 6)*/], items: [Item(name: "fakeID", intro: "detect using", price: 20, size: .small, isChose: false)/*, Item(name: "letter", intro: "read")*/], stats: Stats(health: 100, endurance: 500),
                 bag: [Item(name: "apple", intro: "Food", price: 5, size: .small, isChose: false)],
                 heroLoad: 2,
